...
public class NatureFavoriteRecyclerViewAdapter extends RecyclerView.Adapter<NatureFavoriteRecyclerViewAdapter.ViewHolder> {
    Context context;
    ArrayList<Favorite> favoriteArrayList;

    public NatureFavoriteRecyclerViewAdapter(Context context, ArrayList<Favorite> favoriteArrayList) {
    ...
    @NonNull
    @Override
    public NatureFavoriteRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.favorite_row, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull NatureFavoriteRecyclerViewAdapter.ViewHolder holder, int position) {
